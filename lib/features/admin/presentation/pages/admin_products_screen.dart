...
class _AdminProductsScreenState extends ConsumerState<AdminProductsScreen> {
        ...
        return ListView(
          ...
          children: [
            ...
            ...result.products.map((p) {
              ...
              final displayPrice = _toInt(
                p['is_on_sale'] == true ? p['sale_price'] : p['price'],
              );
              return Padding(
                      ...
                      ListTile(
                        ...
                        leading: _ProductThumb(
                          imageUrl: _resolveImageUrl(
                            _primaryImage(p['images']),
                          ),
                          onTap: () => _openStorePreview(p),
                        ),
  ...
  Future<void> _openStorePreview(Map<String, dynamic> rawProduct) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('No se pudo abrir la vista de tienda: $e')),
      );
    }
  }
...
class _ProductThumb extends StatelessWidget {
  const _ProductThumb({this.imageUrl, this.onTap});
